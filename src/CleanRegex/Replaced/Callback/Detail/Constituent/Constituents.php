...
class Constituents
{
    ...
    public function standardConstituent(StandardModel $model, int $index): Constituent
    {
    ...
    public function legacyConstituent(LegacyModel $model, int $index): Constituent
    {
